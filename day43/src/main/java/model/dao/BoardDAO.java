...
public class BoardDAO {
	...
	final String sql_selectOne="SELECT BID,TITLE,CONTENT,MNAME,DATETIME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID WHERE BID=?";
	final String sql_selectAll="SELECT BID,TITLE,CONTENT,MNAME,DATETIME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID ORDER BY BID DESC";
	final String sql_selectAll_T="SELECT BID,TITLE,CONTENT,MNAME,DATETIME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID "
								+ "WHERE TITLE LIKE '%'||?||'%' ORDER BY BID DESC";
	final String sql_selectAll_C="SELECT BID,TITLE,CONTENT,MNAME,DATETIME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID "
								+ "WHERE CONTENT LIKE '%'||?||'%' ORDER BY BID DESC";
	final String sql_selectAll_W="SELECT BID,TITLE,CONTENT,MNAME,DATETIME FROM BOARD JOIN MEMBER ON BOARD.WRITER = MEMBER.MID "
								+ "WHERE WRITER LIKE '%'||?||'%' ORDER BY BID DESC";	
	...
	//			System.out.println("SelectAll 로그: else" );
